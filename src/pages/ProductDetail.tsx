    ...
    <>
      <div className={loading ? "" : "hidden"}>
        <div className="bg-logogreen text-white md:text-center py-2 px-4">
          Nếu bạn thích xin hãy đánh giá cao chúng tôi {" "}
          <a
            href="https://github.com/Tranvietbach/project-A"
            className="font-bold underline hover:text-indigo-100"
          >
            Bachshop github repo
          </a>
          . xem thêm tại{" "}
          <a
            href="https://github.com/Tranvietbach"
            className="font-bold underline hover:text-indigo-100"
          >
            tài khoản github
          </a>
                ...
                <div className="flex items-center space-x-4 my-4">
                  ...
                  <div className="flex-1">
                    <p className="text-logogreen text-xl font-semibold">
                      Lưu {product.discountPercentage}%
                    </p>
      ...
      <div className={loading ? "hidden" : "h-500"}>
        ...
        >
          ...
          <h1 className="text-2xl">đang xử lý</h1>
        </div>
      </div>
    </>
  );
